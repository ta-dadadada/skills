...
Adapted from [mizchi/skills](https://github.com/mizchi/skills/tree/main/meta/empirical-prompt-tuning)
by mizchi, MIT License (repository default). See [SKILL.md](./SKILL.md) for
which sections are original additions for this repository.
